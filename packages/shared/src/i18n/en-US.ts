...
export const enUS = {
  ...
  diagram: {
    ...
    branchReader: "Branch reading canvas (read-only)",
    branchView: "Branch view",
    branchOverview: "Overview",
    expandBranch: "Expand branch",
    collapseBranch: "Collapse branch",
    focusBranch: "Focus branch",
    showFullMap: "Show full map",
    focusedBranch: "Reading (read-only): {{label}}",
    collapsedBranches: "{{count}} branches collapsed",
    selectBranchHint: "Select a topic to collapse or focus; exports always include the full map",
